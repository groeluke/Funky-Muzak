...
Setup:
 ...
 GOTO ButtonUnpressed
    ...
    ButtonPressed:
        MOVLW 0x01
 XORWF 0x05,1 ;Toggle ((PORTA) and 07Fh), 0
 CALL Delay ;2 Tcy call to delay to cause a delay
 GOTO Main ;2 Tcy

    ButtonUnpressed:
        BCF 0x05,0 ;1 Tcy Force ((PORTA) and 07Fh), 0 low - silence
 GOTO Main ;2 Tcy
